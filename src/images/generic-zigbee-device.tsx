type GenericDeviceProps = React.SVGProps<SVGSVGElement>;

// ./generic-zigbee-device.svg

export function GenericDevice(props: GenericDeviceProps) {
    return (
        <svg viewBox="-2.4 -2.4 28.80 28.80" xmlns="http://www.w3.org/2000/svg" fill="currentColor" {...props}>
